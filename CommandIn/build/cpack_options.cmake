...
set(CPACK_PACKAGE_FILE_NAME "CommandIn-1.0.0")
set(CPACK_RESOURCE_FILE_LICENSE "C:/Users/Datsuo/workspace/RTsummer/CommandIn/COPYING.LESSER")
...
IF (WIN32)
    ...
    set(CPACK_RESOURCE_FILE_LICENSE
        "C:/Users/Datsuo/workspace/RTsummer/CommandIn/cmake/License.rtf")
    configure_file(
        "C:/Users/Datsuo/workspace/RTsummer/CommandIn/cmake/wix.xsl.in"
        "C:/Users/Datsuo/workspace/RTsummer/CommandIn/build/wix.xsl" @ONLY)
    ...
    if(INSTALL_DOCUMENTATION)
        set(CPACK_NSIS_MENU_LINKS
            "C:/Program Files (x86)/CommandIn/share/doc/commandin-1/html/index.html"
            "Component documentation")
    endif(INSTALL_DOCUMENTATION)
    string(REPLACE "/CommandIn" "" install_prefix_root
        "C:/Program Files (x86)/CommandIn")
    file(TO_NATIVE_PATH "${install_prefix_root}" install_prefix_root)
    set(CPACK_NSIS_INSTALL_ROOT "${install_prefix_root}")
    set(CPACK_NSIS_EXTRA_INSTALL_COMMANDS
        "  Rename \"$INSTDIR\\share\\commandin-1\\commandin-config.cmake\" \"$INSTDIR\\commandin-config.cmake\"
  Rename \"$INSTDIR\\share\\commandin-1\\commandin-config-version.cmake\" \"$INSTDIR\\commandin-config-version.cmake\"")
    set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS
        "  Delete \"$INSTDIR\\commandin-config.cmake\"
